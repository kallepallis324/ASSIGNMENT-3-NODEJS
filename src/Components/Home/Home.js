...
class Home extends Component {
    constructor(props) {
        super(props);
        this.state = {
            APILinkForData: 'https://nodeassignmentt3.herokuapp.com/Values',
            Data: [],
            DataReceived: false
        }
    }
            ...
            {this.state.DataReceived ?
                <div className='division'>
                    <table style={{ borderCollapse: 'collapse' }}>
                        <tbody>
                            <tr>
                                <th className='Border-Table' colSpan='3'>Database Stored Data</th>
                            </tr>
                            <tr>
                    ...
                    }}>Filter The Data Using Date and Time</button>
                </div>
                :
                'Loading'
            }
